...
+ (LNNumberpad *)defaultLNNumberpad {
    ...
    dispatch_once(&onceToken, ^{
        defaultLNNumberpad = [[[NSBundle mainBundle] loadNibNamed:@"LNNumberpadiPhone" owner:self options:nil] objectAtIndex:0];
    });
...
- (IBAction)numberpadNumberPressed:(NSString *)sender {
    if (self.targetTextInput) {
        NSString *numberPressed  = sender;
